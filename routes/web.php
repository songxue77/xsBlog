...
Route::group([
    ...
    Route::group(['prefix' => 'df'], function () {
        ...
        // 서버 정보
        Route::get('servers','MainController@serverInfo')->name('servers');
        // 캐릭터 검색
        ...
        Route::get('servers/characterId/skill/buff/equip/equipment','MainController@skillBuffEquipment')->name('skillBuffEquipment');
        // 캐릭터 `버프 스킬 강화 장착 아바타` 조회
        Route::get('servers/characterId/skill/buff/equip/avatar','MainController@skillBuffEquipAvatar')->name('skillBuffEquipAvatar');
        // 캐릭터 `버프 스킬 강화 장착 크리쳐` 조회
        Route::get('servers/characterId/skill/buff/equip/creature','MainController@skillBuffEquipCreature')->name('skillBuffEquipCreature');
